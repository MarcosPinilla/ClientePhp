...
<html>
    ...
    <body>
        ...
        <div class="row" >
            <center>
                <h2>
                    <b>Actividades de un Grupo</b>
                </h2>
            </center>
        </div>
        <center>
            <form class="form-inline"method="post" action="verActividadesDeGrupo.php">
                <div class="row">
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    try {
                        ...
                        $return = $client->verActividadesDeGrupoServicioWeb($params);
                        $gru=  json_decode($return->return);  

                        for ($index = 0; $index < count($gru); $index++) {  
                            echo "<tr>";  
                            echo "<td>",$gru[$index]->{'uid_act'},"</td>";  
                            echo "<td>",$gru[$index]->{'uid_grupo'},"</td>";  
                            echo "<td>",$gru[$index]->{'nombre_act'},"</td>";  
                            echo "<td>",$gru[$index]->{'descripcion_act'},"</td>"; 
                            echo "<td>",$gru[$index]->{'fecha_act'},"</td>";  
                            echo "</tr>";  
                        }
                    } catch (Exception $e) {
