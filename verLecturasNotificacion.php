...
<html>
    ...
    <body>
        ...
        <div class="row" >
            <center>
                <h2>
                    <b>¿Quién leyó la Notificación?</b>
                </h2>
            </center>
        </div>
        <center>
            <form class="form-inline"method="post" action="verLecturasNotificacion.php">
                <div class="row">
                    <div class="form-group">
                        <h4>Uid de la Notificación:</h4><input type="text" placeholder="uid notificación" class="form-control" name="uid" />
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    try {
                        ...
                        $return = $client->verLecturasNotificacionServicioWeb($params);
